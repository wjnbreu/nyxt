...
(defun hide (minibuffer)
  ...
  (lparallel:submit-task
   (interrupt-channel minibuffer)
   (constantly t)) ; To tell prompt-minibuffer to raise exception.
  (lparallel:submit-task
   (channel minibuffer)
   (constantly nil)) ; Unblock prompt-minibuffer after interrupt-channel has been used.
